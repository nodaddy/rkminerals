...
const IncomingEntries = () => {
  const { products, suppliers, bagTypes, entitiesLoading, companyId } =
    useAppContext();
  ...
  // Client bag option
  const clientBagOption = { id: "client-bag", name: "Client's Bag" };
  ...
  const fetchEntriesByDate = async (selectedDate) => {
    ...
    try {
      ...
      const entriesCollectionRef = collection(companyRef, "incomingEntries");
  ...
  const checkForDuplicates = (newEntry) => {
    // Check if there's an entry with the same date, supplier, product and quantity
    return recentEntries.find(
      (entry) =>
        entry.product.id === newEntry.product.id &&
        entry.supplier.id === newEntry.supplier.id &&
            ...
            <table className="entries-table">
              ...
              <tbody>
                ...
                <tr className="form-row">
                  ...
                  <td>
                    <div className="cell-input" ref={supplierDropdownRef}>
                      <div className="searchable-dropdown">
                        <input
                          type="text"
                          ...
                          readOnly={isSubmitting}
                          className={`form-control ${
                            !selectedSupplier ? "input-required" : ""
                          }`}
                          required
                        />
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                ...
                supplier, and quantity on this date. Do you still want to add
                this entry?
              </p>
              <div className="duplicate-details">
                ...
                <div>
                  ...
                  {potentialDuplicate?.supplier?.name}
                </div>
                <div>
                  <strong>Truck No.:</strong> {potentialDuplicate?.truckNumber}
                </div>
              </div>
            </div>
...
export default IncomingEntries;
